...
public class Rob_ID_2_L_Revolute_Joint_Control : MonoBehaviour
{
    /*
    Description:
        Public variables.
    ...
    */
    void Start()
    {
        Q_0 = transform.localEulerAngles; ABB_IRB_14000_L.G_ABB_IRB_14000_L_Str.In_Position[index] = false;
    }
    ...
    */
    void Update()
    {
        ...
        transform.localEulerAngles = new Vector3(Q_0[0], Q_0[1], Q_0[2] + ABB_IRB_14000_L.G_ABB_IRB_14000_L_Str.Q_actual[index]*conversion_value);
    }
