...
public class Rob_ID_2_L_Revolute_Joint_Control_Ghost : MonoBehaviour
{
    /*
    Description:
        Public variables.
    ...
    */
    void Update()
    {
        transform.localEulerAngles = new Vector3(Q_0[0], Q_0[1], Q_0[2] + ABB_IRB_14000_L.G_ABB_IRB_14000_L_Str.Q_target[index]*conversion_value);
    }
